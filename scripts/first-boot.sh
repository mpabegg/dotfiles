...
COSMIC_EPOCH_REPO_URL="https://copr.fedorainfracloud.org/coprs/ryanabx/cosmic-epoch/repo/fedora-${FEDORA_VERSION}/ryanabx-cosmic-epoch-fedora-${FEDORA_VERSION}.repo"
